...
constantForce(-3, 3) {
	...
	sprite.enemyGround = Texture("res/hoge.png");
	sprite.enemyFlying = Texture("res/hoge.png");
	sprite.boss = Texture("res/hoge.png");
...
void es::MainGame::draw() {
	...
	for (auto& enemy : enemies) { enemy->draw(camera.getPos(), sprite.enemyGround); }
